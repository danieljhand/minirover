...
# Set a target speed in revs per second
# Set an interrupt to reset the encoder counter each second
# while loop increasing pulse width each iteration until target speed is met
